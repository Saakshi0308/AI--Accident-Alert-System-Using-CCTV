...
# ---------------- CONFIG ----------------
VIDEO_PATH = r"C:\Users\saksh\Desktop\videoplayback1.mp4"
...
BOT_TOKEN = [
    "8258541351:AAHI-nQcK5FVvue4DAUWVDfl8XKOCqqc87M",
    "8548161858:AAG8xeYaSPmfwNBSkqJ7arKYvDonMJbxx-k"
]
CHAT_ID = [
    "7757744064",
    "7757744064"
...
ROBOFLOW_API_KEY = "BSdevQoOmnakHqZN8yRB"
ROBOFLOW_WORKSPACE = "accident-detection-yeto4"
ROBOFLOW_PROJECT = "crash-detection-0qbaa-arkix"
ROBOFLOW_VERSION = 1
...
def main():
    ...
    # ✅ FIXED: Pass single bot token and chat ID
    notifier = TelegramNotifier(BOT_TOKEN[0], CHAT_ID[0])
